System.register(['react', 'react-dom'], (function (exports) {
  ...
  return {
    ...
    execute: (function () {
      ...
      const App = () => (jsxRuntimeExports.jsxs("div", { children: [jsxRuntimeExports.jsx("h1", { children: "Welcome Friend!" }), jsxRuntimeExports.jsx("p", { children: "Under construction" })] }));

      const { bootstrap, mount, unmount } = i({
          React: require$$0,
          ReactDOM,
          rootComponent: App,
      }); exports({ bootstrap: bootstrap, mount: mount, unmount: unmount });
